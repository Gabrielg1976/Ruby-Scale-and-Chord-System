...
4.times do 
 ...
 4.times do 
   ...
   # Reset to middle C if we go out of the MIDI range 
    note = 0 + key if note < -39 + key or note > 48 + key
    melody.add_notes(note,rand(127)+50,note_length[rand(note_length.size)])
    arp.add_notes(min_ii_arp[rand(min_ii_arp.size)],rand(127)+50,note_length[rand(note_length.size)])
 end
 ...
 4.times do 
   ...
   note = 0 + key if note < -39 + key or note > 48 + key
    ...
    melody.add_notes(note,rand(127)+50,note_length[rand(note_length.size)])
   arp.add_notes(maj_v_arp[rand(maj_v_arp.size)],rand(127)+50,note_length[rand(note_length.size)])
 end 
 ...
 8.times do
   ...
   # Reset to middle C if we go out of the MIDI range 
    note = 0 + key if note < -39 + key or note > 48 + key 
    melody.add_notes(note,rand(127)+50,note_length[rand(note_length.size)])
    arp.add_notes(maj_iv_arp[rand(maj_iv_arp.size)],rand(127)+50,note_length[rand(note_length.size)])
 end
 ...
 4.times do 
   ...
   # Reset to middle C if we go out of the MIDI range 
    note = 0 + key if note < -39 + key or note > 48 + key
    melody.add_notes(note,rand(127)+50,note_length[rand(note_length.size)])
    arp.add_notes(min_iii_arp[rand(min_iii_arp.size)],rand(127)+50,note_length[rand(note_length.size)])
 end
