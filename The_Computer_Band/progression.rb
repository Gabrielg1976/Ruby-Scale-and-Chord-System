...
Number of Lines: 617 lines
File Size:(k)

notes: Build and Fixing the core logic to arpeggition system and The Chord Progression System
...
# Sets the note value to be based off the arp chord and randomize the pattern. 
